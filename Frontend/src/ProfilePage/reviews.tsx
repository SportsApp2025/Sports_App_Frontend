...
const reviews = [
    { name: "Laura W", time: "1 year ago", review: "An incredible, heartfelt musician and a delight to work with." },
    { name: "Kenny B", time: "1 year ago", review: "An incredible, heartfelt musician and a delight to work with." },
    { name: "Nicola B", time: "1 year ago", review: "An incredible, heartfelt musician and a delight to work with." },
];
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-10 mt-10">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-6">
              {reviews.map((review, index) => (
                <div key={index} className="border dark:bg-gray-800 dark:border-gray-600 rounded-lg p-4 shadow-sm">
