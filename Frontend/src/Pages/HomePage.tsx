  ...
  return (
    ...
    <div id="home" className="relative h-screen bg-cover bg-center" style={{ backgroundImage: `url(${Background})` }}>
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="text-lg mb-8 font-Opensans">
              We are a passionate team dedicated to providing the best service and products for our users. Our mission is to revolutionize the industry with cutting-edge solutions and a user-centric approach.
            </p>
            </div>
            </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-lg font-medium mt-2"></span> {/* Text under the icon */}
      </div>
